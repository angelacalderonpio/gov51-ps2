...
The estimated treatment effect is 3.5679, with a standard error of 1.2423, a t-statistic of 2.72, and a p-value of 0.00412. I noticed that the coefficient (3.5679) is identical to the difference in means found in Q3.4. The intercept (57.6352) estimates the average therm2 score for the control group, that is, if treated = 0. Yes, the difference between groups is statistically significant at alpha = 0.05, as it is well below 0.05 (it's 0.00412).
